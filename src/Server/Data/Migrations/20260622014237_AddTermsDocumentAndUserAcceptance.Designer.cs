...
namespace Stallions.Server.Data.Migrations
{
    ...
    [Migration("20260622014237_AddTermsDocumentAndUserAcceptance")]
    partial class AddTermsDocumentAndUserAcceptance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stallions.Server.Data.Entities.Stallion", b =>
                {
                    ...
                    b.Property<Guid?>("StallionDirectoryId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("StallionDirectoryId");
            ...
            modelBuilder.Entity("Stallions.Server.Data.Entities.StallionDirectory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("ArionId")
                        .HasColumnType("int");
                    ...
                    b.Property<Guid>("StudDirectoryId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Stallions.Server.Data.Entities.TermsDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Stallions.Server.Data.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("SuppressBidConfirmation")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Stallions.Server.Data.Entities.Stallion", b =>
                {
                    b.HasOne("Stallions.Server.Data.Entities.StallionDirectory", "StallionDirectory")
                        .WithMany()
                        .HasForeignKey("StallionDirectoryId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("StallionDirectory");
            ...
            modelBuilder.Entity("Stallions.Server.Data.Entities.StallionDirectory", b =>
                {
                    b.HasOne("Stallions.Server.Data.Entities.StudDirectory", "StudDirectory")
                        .WithMany("Stallions")
                        .HasForeignKey("StudDirectoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("StudDirectory");
                });
